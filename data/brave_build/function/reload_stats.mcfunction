...
execute as @a[team=Hobbit] run attribute @s minecraft:movement_speed base set 0.09
...
execute as @a[team=Elytrian] run attribute @s minecraft:burning_time base set 1.1
execute as @a[team=Elytrian] run attribute @s minecraft:luck base set 0.3
execute as @a[team=Elytrian] run attribute @s minecraft:knockback_resistance base set 0.1
